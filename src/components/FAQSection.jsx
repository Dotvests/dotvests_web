...
const FAQS = [
  ...
  {q:"How are my shares protected if DotVests shuts down?",
   a:"Token ownership is recorded on the ChainVault blockchain — an immutable public ledger. Your holdings exist independently of DotVests' operational status. The legal structure governing each tokenized company also provides investor protections outside the platform itself."},
  {q:"Why ChainVault and not Ethereum or Solana?",
   a:"General-purpose blockchains allow anonymous wallets and unrestricted token transfers — both securities law violations by default. ChainVault is purpose-built for regulated securities, with KYC/AML identity verification, transfer restrictions, and compliance rules enforced at the protocol level. It was selected specifically for its alignment with SEC Nigeria's regulatory requirements."},
