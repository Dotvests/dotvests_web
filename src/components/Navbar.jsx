...
const SEARCH_INDEX = [
  ...
  {label:"ChainVault",       page:"tokenize",  keywords:"chainvault blockchain substrate kyc aml"},
  ...
  {label:"Partner Pipeline",  page:"home",      keywords:"nestvest swiftdash delta foods voltage finance partners"},
  ...
  {label:"Token Economics",    page:"token-economics", keywords:"token economics issuance dividend settlement ownership nvt swd"},


  {label:"Legal Notice",      page:"legal",     keywords:"legal notice disclaimer pre-launch arip regulatory trademark liability"},
  {label:"PayLink",          page:"platform",  keywords:"paylink payment rails ngn"},
  {label:"CoinBridge",       page:"platform",  keywords:"coinbridge crypto on ramp"},
];
