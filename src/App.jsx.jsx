...
function Team({go}){
  ...
  return <div style={{padding:"110px 48px 80px"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:2,background:C.brd,marginBottom:72}}>
      {members.map((m,i)=>(
...
function Roadmap({go}){
  ...
  return <div style={{padding:"110px 48px 80px"}}>
    ...
    <div style={{position:"relative",marginBottom:72}}>
      ...
      <div style={{position:"absolute",left:119,top:0,bottom:0,width:1,background:`linear-gradient(to bottom,${C.gold},rgba(201,150,12,0.1))`}}/>

      {milestones.map((m,i)=>(
        <div key={i} style={{display:"grid",gridTemplateColumns:"120px 1fr",gap:40,marginBottom:48,position:"relative"}}>
          {/* Quarter label */}
          ...
          {/* Timeline dot */}
          <div style={{position:"absolute",left:111,top:4,width:16,height:16,borderRadius:"50%",
...
function TokenEconomics({go}){
  ...
  return <div style={{padding:"110px 48px 80px"}}>
    ...
    {/* Core mechanics */}
    <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:1,background:C.brd,marginBottom:72}}>
      {[
