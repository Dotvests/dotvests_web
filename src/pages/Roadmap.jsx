...
function Roadmap({go}){
  const milestones = [
    ...
    {q:"Q4 2025 – Q1 2026",label:"Regulatory Preparation",done:true,items:["OES Grant (₦10M) awarded — first external validation","Legal Instruction Brief produced (Ref: DTV/LIB-2026/001)","ARIP pre-application initiated","Mid-tier legal counsel engaged (Ashcombe Legal)"]},
    {q:"Q2 2026",label:"Active — ARIP Submission",done:false,active:true,items:["SEC Nigeria ARIP formal application","Northgate Capital — broker/custody partnership","Stage 1 asset partner outreach (Thriftmint, SwiftDash, Delta Foods, Ledgerly Finance)","Africa FinTech Accelerator Program"]},
    ...
    {q:"Q4 2026 – Q1 2027",label:"Stage 1 Public",done:false,items:["Full public launch post-ARIP","Stage 1 assets: Thriftmint, SwiftDash, Ledgerly Finance, Delta Foods","Naira fractional investing from ₦1,000","Dividend automation via ChainVault smart contracts"]},
